    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <img src="assets/img/yusuf.png" alt="alex-vidal">
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <p>
                        Hello, I'm Md Yusuf Bin Nur, a passionate and skilled Laravel developer with a strong commitment to crafting efficient and elegant web applications. With [X] years of experience in web development, I have honed my skills in building robust and scalable solutions using the Laravel framework.
                        <br>
                        <br>
                        <br>
                    <h2>Expertise</h2> <br>
                    🌐 <strong> Laravel Development:</strong> Proficient in creating custom web applications from scratch using the Laravel framework, utilizing its powerful features to deliver secure, maintainable, and high-performance solutions.
                    <br>
                    🔍 <strong>API Development:</strong> Experienced in designing and developing RESTful APIs that facilitate seamless communication between different parts of applications.
                    <br>
                    📦 <strong>Package Integration:</strong> Skilled in integrating third-party packages and libraries to extend Laravel's capabilities and streamline development processes.
                    <br>
                    🔄 <strong> Database Management:</strong> Proficient in database design, implementation, and optimization, leveraging tools like Eloquent ORM to ensure efficient data manipulation and storage.
                    <br>
                    🎨 <strong> Frontend Integration:</strong> Familiar with frontend technologies such as HTML, CSS, JavaScript, and Vue.js, enabling me to create interactive and user-friendly interfaces that enhance the user experience.
                    <br>
                    🔒 <strong>Security:</strong> Well-versed in implementing security measures to protect applications against common web vulnerabilities and ensuring data privacy.
                    </p>
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-item-info">
                            ...
                            <a href="https://wedsly.com" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-item-info">
                            ...
                            <a href="https://moonboon.com" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                        </div><!-- /.portfolio-item-info -->
                    </div><!-- /.portfolio-item -->
                </div>
                <div class="col-md-4 col-xs-6">
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-item-info">
                            ...
                            <a href="https://gcare.com.bd" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                        </div><!-- /.portfolio-item-info -->
                    </div><!-- /.portfolio-item -->
                </div>
                <div class="col-md-4 col-xs-6">
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-item-info">
                            ...
                            <a href="https://faraaz.info" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                        </div><!-- /.portfolio-item-info -->
                    </div><!-- /.portfolio-item -->
                </div>
                <div class="col-md-4 col-xs-6">
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-item-info">
                            ...
                            <a href="https://thegreatspoon.xyz" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                        </div><!-- /.portfolio-item-info -->
                    </div><!-- /.portfolio-item -->
                </div>
                <div class="col-md-4 col-xs-6">
    ...
    <section class="site-section section-counters text-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-12">
                    <p class="counter start" data-to="38" data-speed="2000">0</p>
